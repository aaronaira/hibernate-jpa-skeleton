...
@Entity
@Table(name = "factura_linea_pieza")
public class FacturaLineaPieza {
    @EmbeddedId
    private FacturaLineaPiezaId id;
    ...
    public FacturaLineaPiezaId getId() {
        return id;
    }

    public void setId(FacturaLineaPiezaId id) {
        this.id = id;
    }
